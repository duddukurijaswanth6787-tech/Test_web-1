...
export function App() {
  ...
  const overdueClients = clients.filter(
    (c) => c.subscription?.status === "SUSPENDED" || c.subscription?.status === "GRACE_PERIOD"
  ).length;
  const totalMRR = clients.reduce((acc, c) => acc + (c.subscription?.priceInrMonthly || 0), 0);
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <header className="h-16 bg-white border-b border-slate-200/80 px-8 flex items-center justify-between sticky top-0 z-20 shadow-2xs">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <Plus className="w-4 h-4" /> Onboard Boutique Client
            </button>
          </div>
        </header>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                <div className="bg-white border border-slate-200/80 p-5 rounded-3xl shadow-sm flex items-center justify-between">
                  <div>
                    <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Monthly Recurring (MRR)</div>
                    <div className="text-2xl font-bold text-slate-900 mt-1">₹{totalMRR.toLocaleString("en-IN")}</div>
                    <div className="text-[11px] text-emerald-600 font-medium mt-1">Active recurring revenue</div>
                  </div>
                ...
                <div className="bg-white border border-slate-200/80 p-5 rounded-3xl shadow-sm flex items-center justify-between">
                  <div>
                    <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Total Boutique Clients</div>
                    <div className="text-2xl font-bold text-slate-900 mt-1">{totalClients}</div>
                    <div className="text-[11px] text-indigo-600 font-medium mt-1">{activeClients} Active Subscriptions</div>
                  </div>
                ...
                {/* 🌐 Real-Time Live Website & Server Uptime Metric */}
                <div className="bg-white border border-slate-200/80 p-5 rounded-3xl shadow-sm flex items-center justify-between">
                  <div>
                ...
                <div className="bg-white border border-slate-200/80 p-5 rounded-3xl shadow-sm flex items-center justify-between">
                  <div>
                    <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Overdue / Suspended</div>
                    <div className="text-2xl font-bold text-slate-900 mt-1">{overdueClients}</div>
                ...
                <div className="bg-white border border-slate-200/80 p-5 rounded-3xl shadow-sm flex items-center justify-between">
                  <div>
                    ...
                    <div className="text-2xl font-bold text-slate-900 mt-1">{(totalStorageMb / 1024).toFixed(2)} GB</div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-white border border-slate-200/80 rounded-3xl p-6 shadow-sm space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      <h2 className="font-bold text-slate-900 text-sm">Recent Boutique Accounts</h2>
                      <p className="text-xs text-slate-400">Click any store to open full details &amp; AI prompt drawer</p>
                    </div>
                    <button
                      onClick={() => setActiveNav("clients")}
            ...
            <div className="bg-white border border-slate-200/80 rounded-3xl overflow-hidden shadow-sm space-y-4">
              ...
              <div className="p-6 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-50/50">
                <div className="relative flex-1 max-w-md">
                  ...
                  <input
                    type="text"
                    placeholder="Search boutique name, owner, domain, or ClientID..."
                    value={searchQuery}
                    ...
                    {filteredClients.length === 0 ? (
                      <tr>
                        <td colSpan={7} className="text-center py-12 text-slate-400">
                          No boutique clients found matching your search.
                        </td>
                      </tr>
                    ) : (
                          ...
                          >
                            ...
                            <td className="px-6 py-4">
                              ...
                              <div className="text-[10px] text-cyan-700 mt-0.5 font-medium">
                                Storage: {(client.usage.currentStorageBytes / (1024 * 1024)).toFixed(1)} MB
                              </div>
                            </td>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2.5 pt-4 border-t border-slate-100 text-xs text-slate-600">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="font-bold text-emerald-600">✓ {plan.allowWhatsappOrdering ? "Enabled" : "Disabled"}</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span>Custom Domain Whitelist:</span>
                          <span className="font-bold text-emerald-600">✓ {plan.allowCustomDomain ? "Enabled" : "Disabled"}</span>
                        </div>
                        <div className="flex items-center justify-between">
                          <span>Full E-commerce:</span>
                          <span className={`font-bold ${plan.allowEcommerce ? "text-emerald-600" : "text-slate-400"}`}>
                            {plan.allowEcommerce ? "✓ Enabled" : "— Disabled"}
                          </span>
                        </div>
                      </div>
                    </div>
